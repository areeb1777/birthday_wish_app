...
export default function BirthdayWish() {
  ...
  return (
    // Main container
    <div className="h-screen flex items-center justify-center p-4 bg-[url('https://images.pexels.com/photos/6670583/pexels-photo-6670583.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2')] bg-cover bg-center">
      ...
      >
        ...
        <Card className="mx-auto overflow-hidden transition-all duration-300 ease-in-out hover:shadow-xl border-2 border-black">
          ...
          <CardHeader className="text-center">
            ...
            <p className="text-lg text-gray-500">October 24</p>
          </CardHeader>
